...
class Bookwize_Integrated_Meta {
	...
	public $settings = [
		...
		'page_types' => [
			BW_PAGE_TYPE_INTEGRATED => 'Bookwize Integrated Engine Cinnamon',
            'integrated_redirect'   => 'Bookwize Integrated Redirect',
		]
	];
	...
	public function render_meta_box_content( $post ) {
		...
		include plugin_dir_path( dirname( __FILE__ ) ) . 'admin/partials/bookwize-integrated-cinnamon-admin-meta-box.php';
