...
class Bookwize_Integrated {
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-bookwize-integrated-cinnamon-loader.php';

		/**
		 * The class responsible for caching functionality of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-bookwize-integrated-cinnamon-cache.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-bookwize-integrated-cinnamon-i18n.php';

		/**
		 * The class responsive for Bookwize settings page
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-bookwize-integrated-cinnamon-settings.php';

		/**
		 * The class responsible for Bookwize languages
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-bookwize-integrated-cinnamon-languages.php';

		/**
		 * The class responsible for Bookwize meta box
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-bookwize-integrated-cinnamon-meta.php';

		/**
		 * The class responsible for Bookwize shortcode
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-bookwize-integrated-cinnamon-shortcodes.php';


		/**
		 * The class responsible for Bookwize developer API
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-bookwize-integrated-cinnamon-api.php';


		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-bookwize-integrated-cinnamon-admin.php';
