...
if ( ! function_exists( 'bw_load_booking_engine' ) ) {
	function bw_load_booking_engine($content) {
		if( !has_shortcode($content, 'bw_integrated') ){
...
wp_dynamic_css_enqueue( 'my_dynamic_style', plugin_dir_path( __FILE__ ) . 'public/css/bookwize-public.css' );
...
$bw_primary_color = get_option('bw_primary_color');
if( empty($bw_primary_color) ) {
    $bw_primary_color = '#883d4b';
}
set_theme_mod('bw_primary_color', $bw_primary_color);

$bw_secondary_color = get_option('bw_secondary_color');
if( empty($bw_secondary_color) ) {
    $bw_secondary_color = '#b4a27a';
}
set_theme_mod('bw_secondary_color', $bw_secondary_color);

$bw_header_color = get_option('bw_header_color');
if( empty($bw_header_color) ) {
    $bw_header_color = '#2d2d2d';
}
set_theme_mod('bw_header_color', $bw_header_color);

function remove_page_from_url()  {
...
add_action( 'init', 'remove_page_from_url' );


add_shortcode('jcc_redirect_page', 'jcc_redirect_page_function');
function jcc_redirect_page_function($atts=array(), $content='') {
    ob_start();
    include(__DIR__."/public/template-redirect-jcc.php");
