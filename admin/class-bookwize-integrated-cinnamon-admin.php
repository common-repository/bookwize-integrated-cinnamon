...
class Bookwize_Integrated_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->bookwize, plugin_dir_url( __FILE__ ) . 'css/bookwize-integrated-cinnamon-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->bookwize, plugin_dir_url( __FILE__ ) . 'js/bookwize-integrated-cinnamon-admin.js', array(), $this->version, true );
	}
